...
public class TenTweetsForKeywordService {
	...
	public CompletionStage<Map<String, List<Tweet>>> getTenTweetsForKeyword(String searchString) {
		...
		for (String word : searchString.split(" ")) {
			...
			CompletionStage<Map<String, List<Tweet>>> tweetsForWordMap = 
					tokenFuture.thenCompose(token -> getLastTenTweets(token, word));
    ...
    private CompletionStage<Map<String, List<Tweet>>> getLastTenTweets(String accessToken, String word){
